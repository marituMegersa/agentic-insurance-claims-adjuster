...
class AgenticInsuranceClaimsAdjusterSession(Base):
    __tablename__ = "insurance_claims_adjuster_sessions"
...
class AgenticInsuranceClaimsAdjusterItem(Base):
    __tablename__ = "insurance_claims_adjuster_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("insurance_claims_adjuster_sessions.id"))
